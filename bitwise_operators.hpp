...
/////////////////////////////////////////////////////////////////
//
// purpose: enables type-safe bitwise operation on a "flag"-enum
// usage: to enable bitwise operation for enum "enumeration" define
//
/*

template<>
struct enable_bitwise_operators<enumeration> : std::true_type {};
...
namespace impl {
    ...
    template<typename E>
    struct is_enabled_for_operators : enable_bitwise_operators<E> {};
...
template<typename E>
[[nodiscard]]
constexpr std::enable_if_t<enable_bitwise_operators<E>::value, bitmask<E>>
operator~(E value) {
...
template<typename E>
[[nodiscard]]
constexpr std::enable_if_t<enable_bitwise_operators<E>::value, E>
...
[[nodiscard]]
constexpr auto
operator&&(E1 lhs, E2 rhs) ->std::enable_if_t< enable_bitwise_operators<typename impl::bitmask_operation_and_result_t<E1, E2>>::value, bool> {
    return impl::get_underlying(lhs) & impl::get_underlying(rhs);
}

template<typename E>
[[nodiscard]]
constexpr std::enable_if_t<enable_bitwise_operators<E>::value, bool>
...
template<typename E>
[[nodiscard]]
constexpr std::enable_if_t<enable_bitwise_operators<E>::value, void>
